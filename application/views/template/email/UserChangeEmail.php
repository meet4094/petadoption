...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" hola_ext_inject="disabled">
                  ...
                  <td align="center" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tbody>
                        <tr>
                          <td>
                            <h1 style="font-size: 28px;line-height: 110%;margin-bottom: 5px;margin-top: 0;padding: 0;">
                              <div style="margin:0 25px"><a href="<?php echo WEB_URL; ?>" style="display: block;margin: 0px auto;" target="_blank"><img align="none" src="<?php echo BASE_URL . 'images/logo_wide.png'; ?>" style="width: 250px;height:auto !important;margin: 0px;display: inline-block;max-width: 100%;vertical-align: bottom;" width="250"></a></div>
                            </h1>
                          </td>
                        </tr>
                      </tbody>
                      ...
                      <tbody>
                        <tr>
                          <td align="left" valign="top" style="line-height: 150%;font-family: Helvetica;font-size: 14px;color: #8f8f8f;padding: 20px;">
                            ...
                            <p style="color: #000000;font-size: 18px;line-height: 22px;padding: 0 0 10px 0;">There was recently a request to change email for your account. <br><br>If you requested this email change, please click on the following link to chaneg your email:</p>
                            <a class="button" href="<?php echo BASE_URL . 'services/user/changeemail/' . $token; ?>" style="color: #ffffff !important;display: inline-block;font-weight: 500;font-size: 16px;line-height: 42px;font-family: &#39;Helvetica&#39;, Arial, sans-serif;width: auto;white-space: nowrap;height: 42px;margin: 12px 5px 12px 0;padding: 0 22px;text-decoration: none;text-align: center;cursor: pointer;border: 0;border-radius: 3px;vertical-align: top;background-color: #000000 !important;"><span style="display: inline-block;font-family: &#39;Helvetica&#39;, Arial, sans-serif;text-decoration: none;font-weight: 500;font-style: normal;font-size: 16px;line-height: 42px;cursor: pointer;border: none;background-color: #000000 !important;color: #ffffff !important;"><strong>Change Email!</strong></span></a>
