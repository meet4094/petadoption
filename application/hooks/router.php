...
class Router
{
    ...
    public function set_device_identity()
    {
        ...
        if (!self::$is_api) {
            ...
            if (strpos(strtolower($user_agent), "brawlstars") !== FALSE && strpos(strtolower($user_agent), "android") !== FALSE) {
                $os = "android";
                $device_type = "mobile";
                self::$is_api = TRUE;
            } elseif (strpos(strtolower($user_agent), "brawlstars") !== FALSE && strpos(strtolower($user_agent), "iphone") !== FALSE) {
                $os = "iphone";
                $device_type = "mobile";
                self::$is_api = TRUE;
            }
